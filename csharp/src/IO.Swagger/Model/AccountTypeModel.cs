...
namespace IO.Swagger.Model
{
    ...
    public partial class AccountTypeModel :  IEquatable<AccountTypeModel>, IValidatableObject
    {
        ...
        public AccountTypeModel(string name = default(string), string homePage = default(string), string phone = default(string))
        {
            // to ensure "name" is required (not null)
            if (name == null)
            {
                throw new InvalidDataException("name is a required property for AccountTypeModel and cannot be null");
            }
            else
            {
                this.Name = name;
